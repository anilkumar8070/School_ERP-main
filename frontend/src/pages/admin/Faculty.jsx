...
export default function Faculty() {
    ...
    const [newFaculty, setNewFaculty] = useState({ name: '', email: '', subject: '', subjectOther: '', contact: '', experience: '', education: '', classGrade: '', password: '' })
    ...
    function openAdd() { setNewFaculty({ name: '', email: '', subject: '', subjectOther: '', contact: '', experience: '', education: '', classGrade: '', password: '' }); setIsManualSubject(false); setShowAdd(true) }
                            ...
                            <form onSubmit={saveNewFaculty}>
                                <div className="admin-form-grid" style={{ gridTemplateColumns: '1fr' }}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="admin-input" placeholder="Leave empty for auto-generated password" type="text" value={newFaculty.password} onChange={e => setNewFaculty(s => ({ ...s, password: e.target.value }))} />
                                    </div>
                                    <div className="form-group">
                                        <label>Subject</label>
                                        {isManualSubject ? (
