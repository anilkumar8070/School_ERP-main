...
function AddStaffForm({ onClose, onCreated }) {
    const { token } = getAuth()
    const [form, setForm] = useState({ name: '', fatherName: '', email: '', contact: '', designation: '', department: '', password: '' })
                ...
                <form onSubmit={submit}>
                    <div className="admin-form-grid" style={{ gridTemplateColumns: '1fr' }}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="admin-input" placeholder="Leave empty for auto-generated password" value={form.password} onChange={e => setField('password', e.target.value)} />
                        </div>
                        <div className="form-group">
                            <label>Contact</label>
